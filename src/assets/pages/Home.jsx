    ...
    <div className="overflow-x-hidden">
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-12">
          <div className="max-w-2xl reveal-on-scroll active-animation fade-in-up">
      ...
      <section className="w-full bg-[#FAF9F6] py-24 px-6 md:px-12 overflow-hidden">
        <div className="max-w-[1100px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          
          <div className="relative justify-self-center lg:justify-self-start mt-8 lg:mt-0 reveal-on-scroll fade-in-left">
          ...
          <div className="mt-16 lg:mt-0 lg:pl-4 reveal-on-scroll fade-in-right">
      ...
      <section className="w-full bg-[#FAF9F6] pb-32 px-6 md:px-12">
        <div className="max-w-[1240px] mx-auto">
          <div className="text-center mb-20 reveal-on-scroll fade-in-up">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {['gamelan', 'sekaten', 'batik', 'wayang'].map((key, i) => (
              <div 
                key={key} 
                className="bg-[#8b6914] p-3 rounded-xl shadow-md hover:shadow-2xl transition-all flex flex-col h-full reveal-on-scroll fade-in-up"
                style={{ transitionDelay: `${i * 150}ms` }}
              >
                <img 
                  src={`/${key === 'sekaten' ? 'Sekaten' : key === 'batik' ? 'batiksogan' : key}.png`} 
                  alt={t(`home.culture.cards.${key}`)} 
                  className="w-full h-[280px] md:h-[320px] object-cover rounded-lg mb-4"
                />
                <div className="px-1 pb-2 flex-grow">
                  <h3 className="font-serif font-normal text-[#fdf6e4] text-[20px] mb-1.5">{t(`home.culture.cards.${key}`)}</h3>
                  <p className="text-white/90 text-[12.5px] leading-relaxed">
                    {t(`home.culture.cards.${key}Desc`)}
                  </p>
                </div>
              </div>
            ))}
      ...
      <section className="w-full bg-[#EFEBE8] py-32 px-6 md:px-12 relative overflow-hidden">
        <div className="max-w-[1240px] mx-auto reveal-on-scroll zoom-in">
          ...
          <div className="relative group/slider px-4 md:px-0">
            <button onClick={prevSlide} className="absolute left-[-20px] md:left-[-60px] top-1/2 -translate-y-1/2 z-20 w-12 h-12 rounded-full bg-white/80 backdrop-blur-sm border border-[#8b6112]/20 flex items-center justify-center text-[#8b6112] shadow-lg hover:bg-[#8b6112] hover:text-white transition-all duration-300 opacity-0 group-hover/slider:opacity-100 hidden md:flex">
            ...
            <div className="flex transition-transform duration-700 ease-[cubic-bezier(0.25,1,0.5,1)]" style={{ transform: `translateX(-${currentSlide * (100 / 3)}%)` }}>
              {culinaryItems.map((item, index) => (
                <div key={index} className="w-full md:w-1/3 flex-shrink-0 px-4">
                  <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-xl transition-all flex flex-col h-full border border-gray-100">
                    ...
                    <div className="flex-grow">
                      ...
                      <p className="text-[#807b77] text-[13px] leading-[1.6] mb-8">{item.desc}</p>
                    </div>
      ...
      <section className="w-full bg-[#FAF9F6] py-32 px-6 md:px-12">
        <div className="max-w-[1240px] mx-auto">
          <div className="mb-16 reveal-on-scroll fade-in">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="relative group overflow-hidden rounded-2xl h-[500px] lg:h-[700px] shadow-lg reveal-on-scroll fade-in-left">
              <img src="/jlmaliboro.png" alt="Malioboro Quarter" className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" />
            ...
            <div className="flex flex-col gap-8">
              <div className="relative group overflow-hidden rounded-2xl h-[240px] lg:h-[334px] shadow-lg reveal-on-scroll fade-in-right">
                <img src="/tamansari.png" alt="Taman Sari" className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" />
                <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-colors duration-300"></div>
                <div className="absolute bottom-0 left-0 w-full p-8"><h3 className="text-white text-2xl md:text-3xl font-serif drop-shadow-md">{t('home.destination.tamansari')}</h3></div>
              </div>

              <div className="grid grid-cols-2 gap-8 h-[240px] lg:h-[334px]">
                <div className="relative group overflow-hidden rounded-2xl shadow-lg reveal-on-scroll fade-in-up">
                  <img src="/candiborobudur.png" alt="Candi Borobudur" className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" />
                  <div className="absolute bottom-0 left-0 w-full p-6"><h3 className="text-white text-[16px] md:text-xl font-serif drop-shadow-md">{t('home.destination.borobudur')}</h3></div>
                </div>
                <div className="relative group overflow-hidden rounded-2xl shadow-lg reveal-on-scroll fade-in-up" style={{ transitionDelay: '200ms' }}>
                  <img src="/candiprambanan.png" alt="Candi Prambanan" className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" />
                  <div className="absolute bottom-0 left-0 w-full p-6"><h3 className="text-white text-[16px] md:text-xl font-serif drop-shadow-md">{t('home.destination.prambanan')}</h3></div>
                </div>
              </div>
            </div>
          </div>
