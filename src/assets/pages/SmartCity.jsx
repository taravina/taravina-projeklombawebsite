    ...
    <div className="w-full bg-[#FAF9F6] min-h-screen">
      ...
      <section className="py-20 px-6 md:px-12 bg-white">
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Governance Card */}
            <div className="bg-white p-8 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] border border-gray-50 hover:shadow-xl transition-all group reveal-on-scroll fade-in-up">
            ...
            {/* Economy Card */}
            <div className="bg-white p-8 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] border border-gray-50 hover:shadow-xl transition-all group reveal-on-scroll fade-in-up" style={{ transitionDelay: '0.1s' }}>
            ...
            {/* Environment Card */}
            <div className="bg-white p-8 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] border border-gray-50 hover:shadow-xl transition-all group reveal-on-scroll fade-in-up" style={{ transitionDelay: '0.2s' }}>
            ...
            {/* Living Card */}
            <div className="bg-white p-8 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] border border-gray-50 hover:shadow-xl transition-all group reveal-on-scroll fade-in-up" style={{ transitionDelay: '0.3s' }}>
      ...
      <section className="py-20 px-6 md:px-12 bg-[#FAF9F6]">
        <div className="max-w-[1240px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7 bg-[#F2EDE4] rounded-3xl p-8 md:p-12 shadow-sm border border-[#E6DEC9] flex flex-col md:flex-row gap-8 items-start reveal-on-scroll fade-in-left">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center gap-8 pl-0 lg:pl-12 reveal-on-scroll fade-in-right">
      ...
      <section className="py-20 px-6 md:px-12 bg-white">
        <div className="max-w-[1240px] mx-auto text-center">
          ...
          <div className="relative overflow-hidden rounded-[32px] shadow-2xl bg-black aspect-video group reveal-on-scroll zoom-in">
