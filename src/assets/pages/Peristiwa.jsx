          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
            {revolutionCards.map((card, i) => (
              ...
              >
                ...
                <div
                  className={`overflow-hidden transition-all duration-500 ease-in-out ${expandedCard === card.id ? 'max-h-[800px] opacity-100 mb-8' : 'max-h-0 opacity-0'
                    }`}
                >
                ...
                >
                  <div className={`p-3 rounded-full border border-gray-100 transition-all duration-300 ${expandedCard === card.id ? 'bg-[#5e2b0f] text-white border-[#5e2b0f] rotate-180' : 'text-gray-400 group-hover:text-[#8B6112] group-hover:border-[#8B6112]'
                    }`}>
