    ...
    <footer className="w-full bg-[#6d4c32] text-[#e8e4db] py-16 px-6 md:px-12 font-sans">
      <div className="max-w-[1240px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          {/* Column 2: Discovery */}
          <div>
            <h3 className="font-serif text-[#e7c796] text-[19px] mb-6 tracking-wide">{t('footer.discovery.title')}</h3>
          ...
          {/* Column 3: Services */}
          <div>
            <h3 className="font-serif text-[#e7c796] text-[19px] mb-6 tracking-wide">{t('footer.services.title')}</h3>
            <ul className="space-y-4 text-[11.5px] tracking-widest font-bold uppercase text-[#e2dfdb]">
          ...
          <div>
            <h3 className="font-serif text-[#e7c796] text-[19px] mb-6 tracking-wide">{t('footer.information.title')}</h3>
            ...
            <div className="border-t border-[#8c6b4e] pt-6">
              <p className="text-[#e7c796] text-[10px] uppercase font-bold tracking-widest mb-1">{t('footer.questions')}</p>
